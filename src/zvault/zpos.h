...
#ifndef VAULT_LEGACY_ZPOS_H
#define VAULT_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "txdb.h"

class CLegacyZVaultStake : public CStakeInput
{
private:
...
public:
    CLegacyZVaultStake() : CStakeInput(nullptr) {}

    explicit CLegacyZVaultStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZVAULT() const override { return true; }
