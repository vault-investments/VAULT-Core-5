...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VAULT);
    unitlist.append(mVAULT);
    unitlist.append(uVAULT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case VAULT:
        return QString("vault");
    case mVAULT:
        return QString("mvault");
    case uVAULT:
        return QString::fromUtf8("uvault");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZvault)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVAULT)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZVAULT);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVAULT)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZVAULT));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
