...
// Copyright (c) 2015-2018 The VAULT developers
...
#define QAPP_ORG_NAME "VAULT"
#define QAPP_ORG_DOMAIN "vault.org"
#define QAPP_APP_NAME_DEFAULT "VAULT-Qt"
#define QAPP_APP_NAME_TESTNET "VAULT-Qt-testnet"
