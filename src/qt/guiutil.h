...
// Render VAULT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZvault = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZvault = false);
...
// Parse "vault:" URI into recipient object, return true on successful parsing
