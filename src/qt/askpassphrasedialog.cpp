...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            VAULTGUI* window = static_cast<VAULTGUI*>(parentWidget());
...
{
    VAULTGUI* gui = static_cast<VAULTGUI*>(parentWidget());
...
{
    hide();
    static_cast<VAULTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("VAULT will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your VAULTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
