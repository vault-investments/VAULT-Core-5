...
#include "qt/vault/sendmultirow.h"
#include "qt/vault/coldstakingmodel.h"
#include "qt/vault/contactsdropdown.h"
#include "qt/vault/addressholder.h"
...
public:
    explicit ColdStakingWidget(VAULTGUI* parent);
    ~ColdStakingWidget();
