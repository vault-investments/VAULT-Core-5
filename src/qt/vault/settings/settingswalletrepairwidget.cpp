...
#include "qt/vault/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/vault/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VAULTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to VAULTGUI::handleRestart()
