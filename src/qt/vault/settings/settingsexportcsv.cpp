...
#include "qt/vault/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(VAULTGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("VAULT_tx_csv_export(*.csv)") : tr("VAULT_addresses_csv_export(*.csv)"),
                                        nullptr);
