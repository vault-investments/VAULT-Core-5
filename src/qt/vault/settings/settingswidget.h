...
#include <QWidget>
#include "qt/vault/pwidget.h"
#include "qt/vault/settings/settingsbackupwallet.h"
#include "qt/vault/settings/settingsexportcsv.h"
#include "qt/vault/settings/settingsbittoolwidget.h"
#include "qt/vault/settings/settingssignmessagewidgets.h"
#include "qt/vault/settings/settingswalletrepairwidget.h"
#include "qt/vault/settings/settingswalletoptionswidget.h"
#include "qt/vault/settings/settingsmainoptionswidget.h"
#include "qt/vault/settings/settingsdisplayoptionswidget.h"
#include "qt/vault/settings/settingsmultisendwidget.h"
#include "qt/vault/settings/settingsinformationwidget.h"
#include "qt/vault/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(VAULTGUI* parent);
    ~SettingsWidget();
