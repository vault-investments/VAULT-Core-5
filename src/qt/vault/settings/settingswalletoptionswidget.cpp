...
#include "qt/vault/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/vault/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(VAULTGUI* _window, QWidget *parent) :
