...
#include "qt/vault/topbar.h"
#include "qt/vault/forms/ui_topbar.h"
#include "qt/vault/lockunlock.h"
#include "qt/vault/qtutils.h"
#include "qt/vault/receivedialog.h"
#include "qt/vault/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/vault/balancebubble.h"
...
TopBar::TopBar(VAULTGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopVault, ui->labelAmountTopShieldedVault}, "amount-small-topbar");
    setCssProperty({ui->labelAmountVault}, "amount-topbar");
    setCssProperty({ui->labelPendingVault, ui->labelImmatureVault}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // VAULT Total
    QString totalVault = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // VAULT
    // Top
    ui->labelAmountTopVault->setText(totalTransparent);
    ui->labelAmountTopShieldedVault->setText(totalShielded);
    // Expanded
    ui->labelAmountVault->setText(totalVault);
    ui->labelPendingVault->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureVault->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
