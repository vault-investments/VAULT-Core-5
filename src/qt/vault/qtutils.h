...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, VAULTGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, VAULTGUI* gui, double posX = 3);
