...
#include "qt/vault/sendcustomfeedialog.h"
#include "qt/vault/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VAULTGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VAULTGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
