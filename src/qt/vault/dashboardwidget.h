...
#include "qt/vault/furabstractlistitemdelegate.h"
#include "qt/vault/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/vault/txviewholder.h"
...
#include "config/vault-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalVault = 0;
    //qint64 totalZvault = 0;
    qint64 totalMNRewards = 0;
    QList<qreal> valuesVault;
    //QList<qreal> valueszVault;
...
public:
    explicit DashboardWidget(VAULTGUI* _window);
    ~DashboardWidget();
