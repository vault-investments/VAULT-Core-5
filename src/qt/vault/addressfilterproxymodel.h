...
#ifndef VAULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define VAULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //VAULT_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
