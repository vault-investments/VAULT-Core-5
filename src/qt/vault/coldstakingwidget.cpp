...
#include "qt/vault/forms/ui_coldstakingwidget.h"
#include "qt/vault/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/vault/requestdialog.h"
#include "qt/vault/tooltipmenu.h"
#include "qt/vault/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(VAULTGUI* parent) :
    PWidget(parent),
