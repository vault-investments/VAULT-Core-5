...
extern const char * const VAULT_CONF_FILENAME;
extern const char * const VAULT_PID_FILENAME;
extern const char * const VAULT_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("vault-%s", name);
