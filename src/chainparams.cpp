...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    {0, uint256S("0000080539a32f4097e25d72ffe115e7af2eb4a2cc0f9d233119d64033aa0f47")}
};
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // VAULT starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.nVaultBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nVaultBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("1", "185.147.75.100", true);     // 
	...
	vSeeds.emplace_back("5", "185.147.75.104", true);    // 
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x03, 0x13, 0x40, 0x1B};
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x2A, 0x1C, 0x00};
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "vaultks";
...
public:
    CTestNetParams()
    {
        ...
        //vSeeds.emplace_back("fuzzbawls.pw", "vault-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet vault addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vault script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet vault BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet vault BIP32 prvkeys start with 'DRKP'
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "vaultktestsapling";
