#!/usr/bin/env python3
# Copyright (c) 2020 The VAULT Core developers
...
class SaplingMempoolTest(VaultTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 VAULT note to Alice
        ...
        # miner sends another 10 VAULT note to Alice
