...
from test_framework.test_framework import VaultTier2TestFramework
...
class MasternodeGovernanceBasicTest(VaultTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.vault.org/t/test-proposal"
