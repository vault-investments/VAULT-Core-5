...
class ListReceivedTest (VaultTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 VAULT.
        ...
        # Send 1 VAULT to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 VAULT sending them all (fee is 0.1 VAULT)
        ...
        # Confirm transaction (2 VAULT from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 VAULT, send 0.6 VAULT + 0.05 VAULT fee
